...
def pUptLinearPixRmodifWithArrayOfIndexV2(NxNy, maxRad, pix_r, lenLinearArrayRandomInd, tmpLinearArrayRandomInd, tmpOffset1DArray, numPerShell1):
    ...
    lib = ct.CDLL( '/gpfs/cfel/group/cxi/scratch/data/2020/EXFEL-2019-Schmidt-Mar-p002450/scratch/soft/fdip_tweaker/src/vector/RandSelForR.so')
...
def PeakFinder8py(peaklist, data, mask, pix_r,
    ...
    lib = ct.CDLL('/gpfs/cfel/group/cxi/scratch/data/2020/EXFEL-2019-Schmidt-Mar-p002450/scratch/soft/fdip_tweaker/src/vector/peakfinder8.so')
...
#h5Filename = "/gpfs/cfel/group/cxi/scratch/data/2020/EXFEL-2019-Schmidt-Mar-p002450/scratch/soft/fdip_tweaker/src/files_for_test/MPro_5488_1_copy.h5"
h5Filename = "/gpfs/cfel/group/cxi/scratch/data/2020/EXFEL-2019-Schmidt-Mar-p002450/scratch/galchenm/scripts_for_work/cbf_package/fdip_background_new.h5"
dataPathInFile = "/data/data"
dataFile = h5.File(h5Filename, "r")


#maskFilename = "/gpfs/cfel/group/cxi/scratch/data/2020/EXFEL-2019-Schmidt-Mar-p002450/scratch/soft/fdip_tweaker/src/files_for_test/mask_MPro_5488_copy.h5"
maskFilename = "/gpfs/cfel/group/cxi/scratch/data/2020/EXFEL-2019-Schmidt-Mar-p002450/scratch/soft/fdip_tweaker/src/for_background_test/mask_edge_6px.h5"
maskPathInFile = "/data/data"
maskFile = h5.File(maskFilename, "r")

mask = maskFile[maskPathInFile][:]

#geometryFileName = "/gpfs/cfel/group/cxi/scratch/data/2020/EXFEL-2019-Schmidt-Mar-p002450/scratch/soft/fdip_tweaker/src/files_for_test/pilatus6M_200mm.geom"
geometryFileName = "/gpfs/cfel/group/cxi/scratch/data/2020/EXFEL-2019-Schmidt-Mar-p002450/scratch/soft/fdip_tweaker/src/for_background_test/eiger16m_dec19.geom"
