...
if __name__ == "__main__":
    ...
    with h5.File(new_mask, 'a') as f:
        d = f.create_dataset(path_to_mask, (1,16,512,128), maxshape=(None,16,512,128), dtype=np.float32,chunks=(1,16,512,128), compression="gzip", compression_opts=4)
        d[0, :, :, :] = M1
