...
if __name__ == "__main__":
    ...
    #file_cxi = "/gpfs/exfel/u/scratch/SPB/202001/p002450/lyso/scratch/r0095_detectors_virt.cxi"
    #file_cxi = "/gpfs/exfel/u/scratch/SPB/202001/p002450/lyso/scratch/r0096_detectors_virt.cxi"
    file_cxi = "/gpfs/exfel/u/scratch/SPB/202001/p002450/lyso/scratch/r0097_detectors_virt.cxi"

    mask_cxi = "/entry_1/instrument_1/detector_1/mask"
    slab = "/gpfs/cfel/cxi/scratch/data/2020/EXFEL-2019-Schmidt-Mar-p002450/scratch/galchenm/mask/current_work/mask_lyso.h5"
    mask_slab = "/data/data"
    ...
    num_events = subprocess.check_output(['/opt/hdf5/hdf5-1.10.5/bin/h5ls', str(file_cxi)+str(mask_cxi)])
