...
def sum_intensity_calculation(input_stream):
    ...
    with open(input_stream, 'r') as file:
        ...
        for line in file:
            ...
            if line.startswith('Event:'):
                ...
                continue
            if line.find("Peaks from peak search") != -1:
                in_list = 1
                
                data["{} //{}".format(name_of_file, event)] = 0
                continue
            if line.find("End of peak list") != -1:
...
def parsing_stream(input_stream, d):
    name_of_output_streamfile = input_stream.split('.')[0] + "-preselected-strong-patterns-according-to-intensity-of-founded-peaks.stream"
...
if __name__ == "__main__":
    ...
    data_input = sum_intensity_calculation(input_stream)
    ...
    data_output = sum_intensity_calculation(name_of_output_streamfile)
