...
GEOM=$2 #/gpfs/cfel/cxi/scratch/data/2019/LCLS-2011-Boutet-Feb-L220/geom/cxi22010_metrol22010_v7_r193-198.geom 
PDB=$3 #catb.cell
STREAMDIR=streams
ERRORDIR=error
SAVEPATH=lists
...
#    echo "#SBATCH --mem=500000" >> $SLURMFILE
    ...
    command="/gpfs/cfel/cxi/scratch/data/2020/EXFEL-2019-Schmidt-Mar-p002450/scratch/soft/crystfel/build/indexamajig -i $FILE -o $STREAM --serial-start=$POS"
