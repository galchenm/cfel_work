...
def tolstikova_function(run):
    ...
    command = 'source /gpfs/cfel/cxi/scratch/data/2020/EXFEL-2019-Schmidt-Mar-p002450/scratch/galchenm/scripts_for_work/binningANDcompression/run_cheetah_compression_wo_hitfinding.sh {} {}'.format(run, output_dir)
    #print(command)
    os.system(command)
