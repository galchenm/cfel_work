...
cp /gpfs/cfel/cxi/scratch/data/2020/EXFEL-2019-Schmidt-Mar-p002450/scratch/galchenm/scripts_for_work/binningANDcompression/upt_programs/template-binned.yaml monitor.yaml
...
echo "mpirun -np 30 /asap3/petra3/gpfs/p11/2020/data/11009046/scratch_cc/alexandra/cheetah/bin/om_monitor.py files.lst" >> $SLURMFILE
