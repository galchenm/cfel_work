...
def processing(h5Filename):
    ...
    tmp = peak_snr[peak_snr[()] != 0]
    new_peak_snr[:tmp.shape[0],] = tmp[:]
    ...
    tmp = peak_total_intensity[peak_total_intensity[()] != 0]
    new_peak_total_intensity[:tmp.shape[0],] = tmp[:]
    ...
    tmp = peak_num_pixels[peak_num_pixels[()] != 0]
    new_peak_num_pixels[:tmp.shape[0],] = tmp[:]
    ...
    tmp = peak_maximum_value[peak_maximum_value[()] != 0]
    new_peak_maximum_value[:tmp.shape[0],] = tmp[:]
    ...
    tmp = x_pos_raw[x_pos_raw[()] != 0]
    new_x_pos_raw[:tmp.shape[0],] = tmp[:]
    ...
    tmp = y_pos_raw[y_pos_raw[()] != 0]
    new_y_pos_raw[:tmp.shape[0],] = tmp[:]
