...
def filling_template(stream_filename, block_name, output, bin_size=2, min_good_pix_count=3, max_res=600):
    ...
    try:
        ...
        print(stream_filename, minimum_snr)
...
def running_main(blocks_filename, raw_data_path, processed_raw_data_path, output_path, bin_size, min_good_pix_count, forces_template, skip_flag, max_res_value, ccstar_only_estimation, rsplit_ccstar_estimation):
    logger = logging.getLogger('app')
...
if __name__ == "__main__":
    ...
    running_main(blocks_filename, raw_data_path, processed_raw_data_path, output_path, bin_size, min_good_pix_count, forces_template, skip_flag, max_res_value, ccstar_only_estimation, rsplit_ccstar_estimation)
    print('Finished')