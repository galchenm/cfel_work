...
def running_main(blocks_filename, raw_data_path, processed_raw_data_path, output_path):
    ...
    for key in d_info:
        ...
        dat_file = glob.glob(f'{folder}/**/*CCstar.dat', recursive=True)[0] #CCstar dat file for estimation max res for hits finding
        
        data_resolution = calculating_max_res_from_CCstar_dat(dat_file)
