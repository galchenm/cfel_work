...
def multiple_images():
    ...
    for file in Path(dir).glob("**/AGIPD/**/*.h5"):
        name = file.stem
        #for file in glob.glob("/asap3/fs-sc/gpfs/scdd01/2022/data/11015175/scratch_cc/galchenm/for_Tim/AGIPD/gv_few_patterns/float/AGIPD_gv_float_34patterns*.h5"):
        #name = "AGIPD_gv_float_34patterns"
...
df.to_csv('total_info_for_multiple_images.csv')