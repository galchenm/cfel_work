...
def multiple_images():
    ...
    #for file in Path(dir).glob("**/Eiger16M/**/*.h5"):
    #    name = file.stem
    for file in glob.glob("/asap3/fs-sc/gpfs/scdd01/2022/data/11015175/scratch_cc/galchenm/for_Tim/Eiger16M/low_photons/truncated_to_3_bits/Eiger16M*.h5"):
...
df.to_csv('total_info_for_multiple_images_Eiger16M_lacta_int_1k_patterns_ truncated_to_3_bits.csv')